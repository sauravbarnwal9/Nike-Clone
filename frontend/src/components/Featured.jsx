  ...
  return (
    ...
    >
      <Box w={["90%", "90%", "45%"]} textAlign={["center", "center", "left"]}>
        <Text fontSize="40" color="#FFFFFF" fontWeight="bold">
          FEATURED
        </Text>
        <Text color="skyblue" fontSize="20" fontWeight="bold">
          NIKE SNEAKERS AIR LANCING SHOES
        </Text>
        <Text mt="5" color="#B3B3B3">
