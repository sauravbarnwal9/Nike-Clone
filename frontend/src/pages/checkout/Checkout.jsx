      ...
      >
        ...
        >
          <form onSubmit={handleSubmit}>
            <Box>
              <FormLabel fontSize="x-large" fontWeight="bold">
            ...
            <Box
              ...
              gap="3"
              display={cardDetails.payment_type == "card" ? "flex" : "none"}
            >
            ...
            <Box>
              {address ? (
                <Button
                  ...
                  type="submit"
                >
                  {cardDetails.payment_type == "card" ? "Pay" : "Continue"}
                </Button>
              ) : (
                <Address />
              )}
        ...
        <Box color="#fff">
          <Box backdropFilter={"blur(10px)"} padding="10" borderRadius="15px">
            <Text fontSize="x-large" fontWeight="bold" color="greenyellow">
              Your Grand Total:{" "}
